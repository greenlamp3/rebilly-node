...
var utils = module.exports = {
  ...
  isOptionsHash: function (o) {
    return _.isPlainObject(o) && _.some(['api_key', 'idempotency_key', 'rebilly_account'], function(key) {
  ...
  getOptionsFromArgs: function(args) {
    ...
    if (args.length > 0) {
      ...
      if (utils.isAuthKey(arg)) {
        ...
        if (params.rebilly_account) {
          opts.headers['Rebilly-Account'] = params.rebilly_account;
        }
      }
    }
    return opts;
